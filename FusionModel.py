...
main = tkinter.Tk()
main.title("Image Forgery Detection: A Fusion Approach with Lightweight Deep Learning Models")
...
def preprocessDataset():
    ...
    cv2.imshow("Sample Processed Image from Dataset ",test)
    cv2.waitKey(0)
...
font = ('times', 14, 'bold')
title = Label(main, text='Image Forgery Detection : A Fusion Approach with Lightweight Deep Learning Models')
